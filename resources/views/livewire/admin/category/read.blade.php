        ...
        <div class="card">
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover table-striped">
                    <thead>
                        <tr>
                            <th scope="col" style='cursor: pointer' wire:click="sort('category_name')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'category_name') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'category_name') fa-sort-amount-up ml-2 @endif'></i> {{ __('Category_name') }} </th>
                            <th scope="col" style='cursor: pointer' wire:click="sort('category_description')"> <i class='fa @if($sortType == 'desc' and $sortColumn == 'category_description') fa-sort-amount-down ml-2 @elseif($sortType == 'asc' and $sortColumn == 'category_description') fa-sort-amount-up ml-2 @endif'></i> {{ __('Category_description') }} </th>
